...
class DashboardScreen extends StatelessWidget {
  ...
  Widget _buildAIInsightsSection(BuildContext context) {
    return FutureBuilder<Map<String, dynamic>>(
      future: AIService.getSystemHealth(),
      builder: (context, snapshot) {
        ...
        final healthScore = healthData['overall_score'] ?? 0.0;
        final status = healthData['status'] ?? 'Unknown';
        final totalProducts = healthData['total_products'] ?? 0;
        final lowStockCount = healthData['low_stock_count'] ?? 0;
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Ask our AI assistant for detailed insights and recommendations!',
                        style: AppTheme.bodyMedium.copyWith(
                          color: AppTheme.textPrimary,
